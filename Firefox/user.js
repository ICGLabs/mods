...
pref("browser.search.hiddenOneOffs", "Google,Bing,Amazon.co.uk,Chambers (UK),DuckDuckGo,eBay,Twitter,Wikipedia (en)");
...
pref("devtools.toolbox.tabsOrder", "inspector,jsdebugger,styleeditor,performance,memory,netmonitor,storage,dom,webconsole");
